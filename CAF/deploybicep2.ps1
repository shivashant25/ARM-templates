...
New-AzManagementGroupDeployment `
  ...
  $Managment1.ProvisioningState


  if ($Managment2 -eq "Succeeded",$Managment3 -eq "Succeeded", $Managment4 -eq "Succeeded", $Managment5 -eq "Succeeded", $Managment6 -eq "Succeeded", $RG1 -eq "Succeeded", $RG2 -eq "Succeeded")
  {
